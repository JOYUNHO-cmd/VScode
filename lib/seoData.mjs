...
const SITE_ORIGIN = 'https://neutiul.com';
...
export function buildMeta({ pathname, serviceId, regionId, companyInfo = {}, services = [], currentUrl }) {
  ...
  let pageImage = toAbsoluteUrl(companyInfo.logo) || 'https://neutiul.com/images/professional-cleaning.webp';
  ...
  const jsonLdGraph = [
    {
      ...
      logo: companyInfo.logo || 'https://neutiul.com/images/logo.webp',
      image: 'https://neutiul.com/images/professional-cleaning.webp',
