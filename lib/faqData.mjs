// lib/faqData.mjs
//
// Single source of truth for all "안심 Q&A" content. Plain JS (no TS
// syntax) so it can be imported by both:
//   - lib/faqData.ts (typed re-export, consumed by components/FAQSection.tsx)
//   - lib/seoData.mjs (builds the FAQPage JSON-LD — browser + prerender.mjs)
//
// Keeping one source means the FAQPage structured data always matches
// what's actually visible in the on-page accordion, which is what
// Google/AI answer engines expect from FAQPage markup.
